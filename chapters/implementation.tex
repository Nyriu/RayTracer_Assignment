...
\todo[inline]{create toruses without self shadowing}
...
\todo[inline]{show lambertian and different lighting}
\todo[inline]{show CSG and highlight shadows on union shapes}
